...
FLAGS="-frelease -fdata-sections -ffunction-sections -fno-section-anchors -c -O2 -Wall -pipe -fversion=dSINGLE -fversion=USE_SIMD -march=x86-64 -mfpmath=sse -ffast-math -fversion=BindSDL_Static -fversion=SDL_201 -fversion=SDL_Mixer_202 -I`pwd`/import"
CFLAGS="-c -O2 -Wall -pipe -march=x86-64 -mfpmath=sse -ffast-math"
